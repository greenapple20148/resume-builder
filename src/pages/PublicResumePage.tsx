        ...
        return (
            <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--parchment)' }}>
                <div style={{ textAlign: 'center', maxWidth: 420, padding: '0 20px' }}>
                    ...
                    <Link to="/" className="btn btn-gold">Go to ResumeBuildIn →</Link>
                </div>
            </div>
        )
    }
        ...
        <div style={{ minHeight: '100vh', background: 'var(--parchment)' }}>
            ...
            <header style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <Link to="/auth?mode=signup" className="btn btn-gold btn-sm">Create Yours Free →</Link>
                </div>
            </header>
            ...
            <div style={{
                ...
                <Link to="/auth?mode=signup" className="btn btn-gold">Build My Resume — Free →</Link>
            </div>
        </div>
    )
}
