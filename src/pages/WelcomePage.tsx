            ...
            <div className={`max-w-[640px] mx-auto px-5 sm:px-10 pt-10 pb-20 text-center transition-all duration-[600ms] ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
                ...
                <div className="mb-10 animate-[fadeUp_0.5s_ease_0.8s_both]">
                    ...
                    <div className="flex flex-col gap-2.5">
                        {[
                            { to: '/editor/new', icon: 'file-text', title: 'Create Your First Resume', desc: isPaid ? `Start building with all ${plan.name} templates` : 'Start with the free editor — upgrade anytime' },
                            { to: '/themes', icon: 'layers', title: 'Browse Themes', desc: isPaid ? `Preview all ${plan.themeLimit === Infinity ? '' : plan.themeLimit + ' '}premium templates` : 'Preview 30+ professional designs' },
                            ...(isPremiumPlus ? [
                            ...
                            ...(!isPaid ? [
                                { to: '/pricing', icon: 'zap', title: 'Unlock Pro Features', desc: 'Remove watermark, get DOCX export, cover letters & AI tools' },
                            ] : []),
                        ].map((a) => (
                ...
                <div className="animate-[fadeUp_0.5s_ease_0.9s_both]">
                    <Link to={isPaid ? '/dashboard' : '/editor/new'} className="btn btn-gold btn-lg">
