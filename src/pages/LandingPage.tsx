    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroVisual}>
          ...
          <div className={styles.floatingBadges}>
            <div className={styles.floatingBadge} style={{ '--delay': '0s' } as React.CSSProperties}>
              ✓ ATS Friendly
            </div>
            <div className={styles.floatingBadge} style={{ '--delay': '0.3s' } as React.CSSProperties}>
              ⚡ Instant PDF
            </div>
            <div className={styles.floatingBadge} style={{ '--delay': '0.6s' } as React.CSSProperties}>
              ✦ 25 Themes
            </div>
          </div>
        </div>
      ...
      <section className={styles.features}>
        ...
        <div className={styles.featureGrid}>
          {FEATURES.map((f, i) => (
            <div key={i} className={styles.featureCard} style={{ animationDelay: `${i * 0.08}s` } as React.CSSProperties}>
