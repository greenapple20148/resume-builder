    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section aria-label="Product experience" className="max-w-[1200px] mx-auto px-5 sm:px-10 py-16 sm:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-center">
            <div>
              ...
              <Link href="/auth?mode=signup" className="btn btn-outline">Try It Free →</Link>
            </div>
        ...
        <section aria-label="Call to action" className="bg-gradient-to-br from-[#0e0d0b] to-[#3a3830] dark:from-[#0e0d0b] dark:to-[#3a3830] px-10 py-24 text-center relative overflow-hidden">
          ...
          <Link href="/auth?mode=signup" className="btn btn-gold btn-lg mt-6 relative">Create Your Resume →</Link>
        </section>
      ...
      <footer className="bg-[#1a1916] dark:bg-[#0d0d0c] px-5 sm:px-10 pt-16 text-[rgba(250,248,243,0.6)]" role="contentinfo">
        <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row gap-10 sm:gap-20 pb-12 border-b border-[rgba(255,255,255,0.06)] dark:border-[rgba(255,255,255,0.1)]">
          ...
          <nav aria-label="Footer navigation" className="flex gap-8 sm:gap-16 flex-wrap">
            {[
              { title: 'Product', links: [{ href: '/themes', text: 'Themes' }, { href: '/pricing', text: 'Pricing' }, { href: '/dashboard', text: 'Dashboard' }] },
              { title: 'Company', links: [{ href: '/about', text: 'About' }, { href: '/blog', text: 'Blog' }, { href: '/contact', text: 'Contact' }] },
              { title: 'Legal', links: [{ href: '/privacy', text: 'Privacy' }, { href: '/terms', text: 'Terms' }, { href: '/cookies', text: 'Cookies' }, { href: '/refund-policy', text: 'Refund Policy' }] },
            ].map((col) => (
              <div key={col.title} className="flex flex-col gap-2.5">
                ...
                {col.links.map((l) => (
                  <Link key={l.text} href={l.href} className="text-sm text-[rgba(250,248,243,0.5)] dark:text-[rgba(250,248,243,0.6)] no-underline transition-colors hover:text-parchment dark:hover:text-[#e8e6e0]">{l.text}</Link>
                ))}
              </div>
            ))}
          </nav>
