    ...
    const signUpPrompt = (
        <div className="text-center py-14">
            ...
            <div className="flex gap-3 justify-center">
                <Link href="/auth?mode=signup" className="btn btn-gold">Create Free Account →</Link>
                <Link href="/auth" className="btn btn-outline">Log In</Link>
            </div>
        </div>
    )
    ...
    return (
        <div className="min-h-screen bg-[var(--bg)]">
            ...
            <div className="max-w-[1200px] mx-auto px-5 sm:px-10 py-10">
                {/* Header */}
                <div className="mb-8">
                    <Link href="/dashboard" className="text-xs text-ink-30 hover:text-gold transition-colors mb-3 inline-block">← Back to Dashboard</Link>
