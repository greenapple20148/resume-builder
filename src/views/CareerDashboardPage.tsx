        ...
        return (
            <div className="min-h-screen">
                ...
                <div className="max-w-[560px] mx-auto px-10 py-20 text-center">
                    ...
                    <Link href="/pricing" className="btn btn-gold btn-lg">Upgrade to Career+ →</Link>
                </div>
            </div>
        )
    }
        ...
        <div className="min-h-screen bg-[var(--bg)]">
            ...
            <div className="max-w-[1000px] mx-auto px-6 pt-8 pb-20">
                    ...
                    <>
                        {loading ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <Link href="/tools/mock-interview" className="btn btn-gold btn-lg">Start Mock Interview →</Link>
                            </div>
                        ) : (
                            <>
                                {/* Stats Grid */}
                    ...
                    <>
                        {!resumeStats ? (
                            <div className="text-center py-20">
                                ...
                                <Link href="/dashboard" className="btn btn-gold btn-lg">Go to My Resumes →</Link>
                            </div>
                        ) : (
                            <>
                                {/* Stats */}
                                ...
                                <div className="bg-white dark:bg-[var(--surface)] border border-ink-10 rounded-2xl p-6">
                                    ...
                                    <div className="space-y-3">
                                        {resumeStats.scored.map((r, i) => {
                                            ...
                                            return (
                                                <Link key={r.id} href={`/editor/${r.id}`} className="flex items-center gap-4 p-4 rounded-xl bg-[var(--bg)] border border-ink-10 transition-all hover:border-gold hover:shadow-sm no-underline">
                ...
                <div className="flex flex-wrap gap-3 mt-8 justify-center">
                    <Link href="/tools/mock-interview" className="btn btn-gold">Start Mock Interview</Link>
                    <Link href="/dashboard" className="btn btn-outline">My Resumes</Link>
                    <Link href="/tools/ai" className="btn btn-ghost">AI Tools</Link>
                </div>
            </div>
        </div>
    )
