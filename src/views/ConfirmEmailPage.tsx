                ...
                <div className="w-full max-w-[520px] bg-[var(--white)] border border-ink-10 rounded-xl shadow-lg px-10 py-12 text-center relative overflow-hidden animate-[fadeUp_0.5s_ease_both]">
                    ...
                    <div className="pt-1">
                        ...
                        <div className="flex gap-2.5 justify-center flex-wrap">
                            <Link href="/auth?mode=signup" className="btn btn-outline btn-sm">← Try Again</Link>
                            <Link href="/auth?mode=signin" className="btn btn-ghost btn-sm">Sign In Instead</Link>
                        </div>
                    </div>
                </div>
